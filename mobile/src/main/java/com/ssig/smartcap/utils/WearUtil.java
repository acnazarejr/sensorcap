...
//            WearUtil.requestSensorInfoLatch.countDown();
    ...
    public static void initialize(Context context){
        MESSAGE_PATH_CONNECTION_DONE = context.getString(R.string.message_path_client_service_connection_done);
        MESSAGE_PATH_REQUEST_WATCH_SENSORINFO = context.getString(R.string.message_path_client_service_request_watch_sensorinfo);
        MESSAGE_PATH_RESPONSE_WATCH_SENSORINFO = context.getString(R.string.message_path_host_service_response_watch_sensorinfo);
        MESSAGE_PATH_SYNC_NTP = context.getString(R.string.message_path_client_service_sync_ntp);
        MESSAGE_PATH_DISCONNECT = context.getString(R.string.message_path_client_service_disconnect);
        Wearable.getMessageClient(context).addListener(new WearUtil());
    }

    public static boolean hasWearOS(Context context){
        return DeviceTools.isAppInstalled(context, context.getString(R.string.util_wear_package));
    }
