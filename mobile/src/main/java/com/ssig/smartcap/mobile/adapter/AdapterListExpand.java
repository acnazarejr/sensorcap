...
public class AdapterListExpand extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<SensorInfo> items = new ArrayList<>();
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, SensorInfo obj, int position);
    }
    ...
    public AdapterListExpand(Context context, List<SensorInfo> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            final SensorInfo p = items.get(position);
            view.name.setText(p.getSensorType().toString());
