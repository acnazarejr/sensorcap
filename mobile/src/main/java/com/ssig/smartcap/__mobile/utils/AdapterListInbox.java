...
//
//        public TextView name, duration, message, date, image_letter;
...
//        holder.name.setText(inbox.name);
//        holder.duration.setText(inbox.duration);
//        //holder.message.setText(inbox.duration);
