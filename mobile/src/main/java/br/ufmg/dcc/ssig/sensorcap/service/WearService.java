package br.ufmg.dcc.ssig.sensorcap.service;
...
import br.ufmg.dcc.ssig.sensorcap.utils.DeviceTools;
...
public class WearService extends Service implements MessageClient.OnMessageReceivedListener{
    ...
    private Node getFirstCapableNode() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        Task<CapabilityInfo> capabilityInfoTask = Wearable.getCapabilityClient(this).getCapability(getString(R.string.capability_sensorcap_wear), CapabilityClient.FILTER_REACHABLE);
