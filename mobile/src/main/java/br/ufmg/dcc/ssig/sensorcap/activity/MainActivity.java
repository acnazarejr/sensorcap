...
import br.ufmg.dcc.ssig.sensorcap.adapter.ViewPagerAdapter;
import br.ufmg.dcc.ssig.sensorcap.fragment.*;
...
public class MainActivity extends AppCompatActivity implements
    ...
    public void onCapabilityChanged(@NonNull CapabilityInfo capabilityInfo) {
        if (capabilityInfo.getName().equals(getString(R.string.capability_sensorcap_wear)) && capabilityInfo.getNodes().isEmpty())
            this.resetWearClientConnection(false);
    }
    ...
    private void initSettings(){
        this.dialogSettings =  new MaterialDialog.Builder(Objects.requireNonNull(this))
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        ...
                        RadioGroup radioGroupSensorFileType = view.findViewById(R.id.sensor_file_type_radio_group);
                        SensorWriterType sensorWriterType = (radioGroupSensorFileType.getCheckedRadioButtonId() == R.id.sensor_file_type_binary_radio_option) ? SensorWriterType.BINARY : SensorWriterType.CSV;
                        editor.putString(getString(R.string.preference_main_key_sensor_writer_type), sensorWriterType.code());
        ...
        String sensorWriterTypeCode = this.sharedPreferences.getString(getString(R.string.preference_main_key_sensor_writer_type), getResources().getString(R.string.preference_main_default_sensor_writer_type));
        SensorWriterType sensorWriterType = SensorWriterType.fromCode(sensorWriterTypeCode);
        RadioGroup radioGroupSensorFileType = view.findViewById(R.id.sensor_file_type_radio_group);
        if(sensorWriterType == SensorWriterType.BINARY) {
            radioGroupSensorFileType.check(R.id.sensor_file_type_binary_radio_option);
        }else{
            radioGroupSensorFileType.check(R.id.sensor_file_type_csv_radio_option);
        }
    ...
    private void initAbout(){
        ...
        TextView textAppVersion = view.findViewById(R.id.app_version_text);
        ...
        buttonGetCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.setData(Uri.parse("https://github.com/acnazarejr/sensorcap"));
                startActivity(i);
            }
        });
    }
